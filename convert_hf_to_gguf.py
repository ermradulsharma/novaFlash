...
class ModelBase:
    ...
    def __init__(self, dir_model: Path, ftype: gguf.LlamaFileType, fname_out: Path, *, is_big_endian: bool = False,
        ...
        self.deepseek4_expert_outtypes = deepseek4_expert_outtypes
        self.deepseek4_max_layers = deepseek4_max_layers
        self.deepseek4_expert_workers = deepseek4_expert_workers
...
class DeepseekV4Model(TextModel):
    ...
    def _load_ggml_quant_lib(cls):
        ...
        candidates = [
            ...
            root / "build" / "bin" / "libggml.dylib",
            root / "build" / "bin" / "libggml.so",
            root / "build" / "bin" / "ggml.dll",
        ]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--outtype", type=str, choices=["f32", "f16", "bf16", "q8_0", "iq2_xxs", "iq2_xs", "q2_k", "tq1_0", "tq2_0", "auto"], default="auto",
        help="output format - use f32 for float32, f16 for float16, bf16 for bfloat16, q8_0 for Q8_0, iq2_xxs/iq2_xs for importance-quantized 2-bit, q2_k for K-quant 2-bit, tq1_0 or tq2_0 for ternary, and auto for the highest-fidelity 16-bit float type",
    )
    parser.add_argument(
